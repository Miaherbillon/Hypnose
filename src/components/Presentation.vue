  ...
  <div class="P">
    ...
    <div>
      ...
      <ul>
        ...
        <li>Un endroit calme et propice à la relaxation</li>
      </ul>
      <p>
      ...
      <p>
        <strong>
          Prêt(e) à vous libérer du stress et à atteindre vos objectifs ?
        </strong>
        <br />
...
.tarif {
  ...
  overflow: hidden;
  box-shadow: 0 0.5em 1.5em 0 rgba(0, 0, 0, 0.6);
